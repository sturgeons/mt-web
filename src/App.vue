...
#app {
  margin: 0;
  font-family: "CircularStdBook", "Helvetica Neue", Helvetica, Arial, "PingFang SC", "Hiragino Sans GB", "Heiti SC", "Microsoft YaHei", "WenQuanYi Micro Hei", sans-serif;
...
@font-face {
  ...
  url('@/assets/fonts/jira.svg') format('svg');
  font-weight: normal;
  font-style: normal;
}
